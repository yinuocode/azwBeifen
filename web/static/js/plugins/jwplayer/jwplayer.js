...
"undefined" === typeof jwplayer && (jwplayer = function() {
        if (jwplayer.api) return jwplayer.api.selectPlayer.apply(this, arguments) }, jwplayer.version = "6.12.4956", jwplayer.vid = document.createElement("video"), jwplayer.audio = document.createElement("audio"), jwplayer.source = document.createElement("source"), function() {
        var f = {},
            d = Array.prototype,
            l = Object.prototype,
            b = d.slice,
            ...
            w = m.each = m.forEach = function(e, b, h) {
                ...
                if (a && e.forEach === a) e.forEach(b, h);
                    ...
                    for (var c = 0, p = e.length; c < p; c++) {
                        if (b.call(h, e[c], c, e) === f) return } else
        ...
        m.map = m.collect = function(a, e, b) {
            ...
            w(a, function(a, c, p) { h.push(e.call(b, a, c, p)) });
            return h };
        ...
        m.filter = m.select = function(a, b, h) {
            ...
            w(a, function(a, e, p) { b.call(h, a, e, p) && c.push(a) });
            return c };
        m.every = m.all = function(a, e, b) { e || (e = m.identity);
            var h = !0;
            if (null == a) return h;
        ...
        m.sortedIndex = function(a, e, h, b) { h = null == h ? m.identity : m.isFunction(h) ? h : m.property(h);
            e = h.call(b, e);
        ...
        u = m.some = m.any = function(a, e, h) { e || (e = m.identity);
            var b = !1;
            if (null == a) return b;
        ...
        m.isObject = function(a) {
            return a === Object(a) };
        w("Arguments Function String Number Date RegExp".split(" "), function(a) { m["is" + a] = function(e) {
        ...
        function l(a, e, c, d, h) {
            return function() {
                ...
                if (h) c(a);
                    ...
                    try {
                        if (p = a.responseXML)
                            if (g = p.firstChild, p.lastChild && "parsererror" === p.lastChild.nodeName) { d && d("Invalid XML", e, a);
                                return } } catch (k) {}
                    if (p && g) return c(a);
                    (p = b.parseXML(a.responseText)) && p.firstChild ? (a = b.extend({}, a, { responseXML: p }), c(a)) : d && d(a.responseText ? "Invalid XML" :
                        e, e, a)
                }
            }
        }
        ...
        b.getAbsolutePath = function(a, e) {
            ...
            if (b.exists(a)) {
                var c;
                if (b.exists(a)) { c = a.indexOf("://");
                    var d = a.indexOf("?");
                    c = 0 < c && (0 > d || d > c) } else c = void 0;
                if (c) return a;
        ...
        b.extend = function() {
            ...
            if (1 < a.length) {
                for (var e = a[0], c = function(a, b) { void 0 !== b && null !== b && (e[a] = b) }, d = 1; d < a.length; d++) b.foreach(a[d], c);
                return e }
            return null };
        var c = window.console = window.console || { log: function() {} };
        b.log = function() {
            var a = Array.prototype.slice.call(arguments, 0); "object" === typeof c.log ? c.log(a) : c.log.apply(c, a) };
        ...
        b.saveCookie = function(a, e) { document.cookie = "jwplayer." + a + "\x3d" + e + "; path\x3d/" };
        ...
        //         var d = c.data;
        //         delete c.data;
        //         c = b.extend(c, d) } else "object" === typeof c.metadata && b.deepReplaceKeyName(c.metadata, ["__dot__", "__spc__", "__dsh__", "__default__"], [".", " ", "-", "default"]);
        //     b.foreach(["position", "duration", "offset"], function(a, e) { c[e] && (c[e] = Math.round(1E3 * c[e]) / 1E3) });
        //     return c
        // };
        b.flashVersion = function() {
            ...
            var a = navigator.plugins,
                e;
            try {
                if ("undefined" !== a && (e = a["Shockwave Flash"])) return parseInt(e.description.replace(/\D+(\d+)\..*/, "$1"), 10) } catch (c) {}
        ...
        var k = b.pluginPathType = { ABSOLUTE: 0, RELATIVE: 1, CDN: 2 };
        ...
        b.youTubeID = function(a) {
            try {
                return /v[=\/]([^?&]*)|youtu\.be\/([^?]*)|^([\w-]*)$/i.exec(a).slice(1).join("").replace("?", "") } catch (e) {
                return "" } };
        ...
        b.repo = function() {
            ...
            try { b.isHTTPS() && (a = a.replace("http://", "https://ssl.")) } catch (c) {}
            return a };
        b.versionCheck = function(a) { a = ("0" + a).split(/\W/);
        ...
        b.ajax = function(a, c, d, g) {
                ...
                h.onreadystatechange = function() {
                    if (4 === k.readyState) switch (k.status) {
                        case 200:
                            ...
                            break;
                        case 404:
                            d("File not found", j, k) } } } else return d && d("", a, h), h;
            h.overrideMimeType && h.overrideMimeType("text/xml");
            var f = a,
                t = h;
            h.onerror = function() { d("Error loading file", f, t) };
            try {
                h.open("GET",
                    a, !0)
            } catch (n) { p = !0 }
            setTimeout(function() {
                if (p) d && d(a, a, h);
                else try { h.send() } catch (c) { d && d(a, a, h) } }, 0);
            return h
        };
        b.parseXML = function(a) {
            ...
            try {
                if (window.DOMParser) {
                    if (c = (new window.DOMParser).parseFromString(a, "text/xml"), c.childNodes && c.childNodes.length && "parsererror" === c.childNodes[0].firstChild.nodeName) return } else c = new window.ActiveXObject("Microsoft.XMLDOM"), c.async = "false", c.loadXML(a) } catch (b) {
                return }
            return c };
        ...
        b.addClass = function(a,
            ...
            j.each(g, function(a) { j.contains(d, a) || d.push(a) });
        ...
        function j(c) {
            ...
            if (b) {
                ...
                if (void 0 !== d && d < e.length && e[d].selectorText === c) {
                    ...
                    b.deleteRule(d) } else d = e.length, r[c] = d;
                try {
                    b.insertRule(k,
                        d)
                } catch (l) {}
        ...
        c.cssKeyframes = function(a, c) {
            ...
            var b = b.sheet,
                e = "@keyframes " + a + " { " + c + " }";
            try { b.insertRule(e, b.cssRules.length) } catch (k) {}
            e = e.replace(/(keyframes|transform)/g, "-webkit-$1");
            try { b.insertRule(e, b.cssRules.length) } catch (j) {} };
        ...
        q.style = function(a, c, d) {
            if (!(void 0 === a || null === a)) { void 0 === a.length && (a = [a]);
                var g = {},
                    k;
                for (k in c) g[k] = l(k, c[k]);
                if (null !== e && !d) { c = (c = a.__cssRules) || {};
                    for (var j in g) c[j] = g[j];
                    a.__cssRules = c;
                    0 > f._.indexOf(e.elements, a) && e.elements.push(a) } else b(a, g) } };
        q.block = function(a) { null === e && (e = { id: a, styleSheets: {}, elements: [] }) };
        ...
        c.transform = function(a, c) {
            ...
            b["-ms-transform"] = c;
            b["-moz-transform"] = c;
            b["-o-transform"] = c; "string" === typeof a ? q(a, b) : q.style(a, b) };
        c.dragStyle = function(a, c) { q(a, { "-webkit-user-select": c, "-moz-user-select": c, "-ms-user-select": c, "-webkit-user-drag": c, "user-select": c, "user-drag": c }) };
        c.transitionStyle = function(a, c) { navigator.userAgent.match(/5\.\d(\.\d)? safari/i) || q(a, { "-webkit-transition": c, "-moz-transition": c, "-o-transition": c, transition: c }) };
        c.rotate = function(a, b) { c.transform(a, "rotate(" + b + "deg)") };
        c.rgbHex = function(a) { a = String(a).replace("#", "");
        ...
        var d = jwplayer._,
            l = f.foreach,
            b = { mp4: "video/mp4", ogg: "video/ogg", oga: "audio/ogg", vorbis: "audio/ogg", webm: "video/webm", aac: "audio/mp4", mp3: "audio/mpeg", hls: "application/vnd.apple.mpegurl" },
            j = { mp4: b.mp4, f4v: b.mp4, m4v: b.mp4, mov: b.mp4, m4a: b.aac, f4a: b.aac, aac: b.aac, mp3: b.mp3, ogv: b.ogg, ogg: b.ogg, oga: b.vorbis, vorbis: b.vorbis, webm: b.webm, m3u8: b.hls, m3u: b.hls, hls: b.hls },
            c = f.extensionmap = {};
        l(j, function(b, d) { c[b] = { html5: d } });
        l({
            flv: "video",
            f4v: "video",
            mov: "video",
        ...
        var d = f.loaderstatus = { NEW: 0, LOADING: 1, ERROR: 2, COMPLETE: 3 };
        f.scriptloader = function(l) {
            function b(a) { k = d.ERROR;
            ...
            this.load = function() {
                if (k === d.NEW) {
                    ...
                    if (a && (k = a.getStatus(), 2 > k)) { a.addEventListener(c.ERROR, b);
        ...
        f.stringToColor = function(d) { d = d.replace(/(#|0x)?([0-9A-F]{3,6})$/gi, "$2");
    ...
    function(f) {
        var d = "touchmove",
            l = "touchstart";
        f.touch = function(b) {
            function j(b) { b.type === l ? (a = !0, r = g(h.DRAG_START, b)) : b.type === d ? a && (q || (c(h.DRAG_START, b, r), q = !0), c(h.DRAG, b)) : (a && (q ? c(h.DRAG_END, b) : (b.cancelBubble = !0, c(h.TAP, b))), a = q = !1, r = null) }
            ...
            function g(a, c) {
                ...
                var e = k.getBoundingClientRect(),
                    b = { type: a, target: k, x: b.pageX - window.pageXOffset - e.left, y: b.pageY, deltaX: 0, deltaY: 0 };
            ...
            document.addEventListener("touchend", function(b) { a && q && c(h.DRAG_END, b);
                a = q = !1;
                r = null });
            document.addEventListener("touchcancel", j);
            b.addEventListener(l, j);
            b.addEventListener("touchend", j);
            this.addEventListener = function(a, c) { e[a] = c };
            this.removeEventListener = function(a) { delete e[a] };
            return this
        }
    }(jwplayer.utils),
    function(f) { f.touchEvents = { DRAG: "jwplayerDrag", DRAG_START: "jwplayerDragStart", DRAG_END: "jwplayerDragEnd", TAP: "jwplayerTap" } }(jwplayer.utils),
    function(f) {
        f.key = function(d) {
            var l, b, j;
    ...
    function(f) {
        ...
        d.encrypt = function(j, c) {
            ...
            1 >= g.length && (g[1] = 0);
            for (var k = d.strToLongs(b.encode(c).slice(0, 16)), a = g.length, e = g[a - 1], f = g[0], q, h = Math.floor(6 + 52 / a), p = 0; 0 < h--;) { p += 2654435769;
                q = p >>> 2 & 3;
        ...
        d.decrypt = function(j, c) {
            if (0 == j.length) return "";
            for (var g = d.strToLongs(l.decode(j)), k = d.strToLongs(b.encode(c).slice(0, 16)), a = g.length, e = g[a - 1], f = g[0], q, h = 2654435769 * Math.floor(6 + 52 / a); 0 != h;) { q = h >>> 2 & 3;
        ...
        var l = {
            ...
            b = {
                encode: function(b) { b = b.replace(/[\u0080-\u07ff]/g, function(c) { c = c.charCodeAt(0);
            ...
            function j(c, a, b) {
                if (c)
                    for (var g = 0; g < c.length; g++) {
                        var f =
                            c[g];
                        if (f) { null !== f.count && 0 === --f.count && delete c[g];
                            try { f.listener(a) } catch (h) { d.log('Error handling "' + b + '" event listener [' + g + "]: " + h.toString(), f.listener, a) } }
                    }
            }
            var c, g;
            this.resetEventListeners = function() { c = {};
                g = [] };
            this.resetEventListeners();
            this.addEventListener = function(b, a, e) {
                try { d.exists(c[b]) || (c[b] = []), "string" === d.typeOf(a) && (a = (new Function("return " + a))()), c[b].push({ listener: a, count: e || null }) } catch (g) { d.log("error", g) }
                return !1 };
                ...
                if (c[b]) {
                    try {
                        ...
                        for (e = 0; e < c[b].length; e++)
                            if (c[b][e].listener.toString() === a.toString()) { c[b].splice(e, 1);
                                break }
                    } catch (g) { d.log("error", g) }
                    return !1
                }
            };
            this.addGlobalListener = function(b, a) {
                try { "string" === d.typeOf(b) && (b = (new Function("return " + b))()), g.push({ listener: b, count: a || null }) } catch (c) { d.log("error", c) }
                return !1 };
            this.removeGlobalListener = function(b) {
                if (b) {
                    try {
                        for (var a = g.length; a--;) g[a].listener.toString() === b.toString() && g.splice(a, 1) } catch (c) { d.log("error", c) }
                    return !1 } };
            this.sendEvent =
                function(k, a) { d.exists(a) || (a = {});
                    d.extend(a, { id: l, version: f.version, type: k });
                    b && d.log(k, a);
                    j(c[k], a, k);
                    j(g, a, k) }
        }
    ...
    function(f) {
        var d = {},
            l = {};
        f.plugins = function() {};
        f.plugins.loadPlugins = function(b, j) { l[b] = new f.plugins.pluginloader(new f.plugins.model(d), j);
            return l[b] };
        f.plugins.registerPlugin = function(b, j, c, g) {
            var k = f.utils.getPluginName(b);
            d[k] || (d[k] = new f.plugins.plugin(b));
            d[k].registerPlugin(b, j, c, g) } }(jwplayer),
    function(f) {
    ...
    function(f) {
        ...
        f.plugin = function(b) {
            ...
            function c() { q = setTimeout(function() { k = d.loaderstatus.COMPLETE;
                    h.sendEvent(l.COMPLETE) }, 1E3) }

            function g() {
                k =
                    d.loaderstatus.ERROR;
                h.sendEvent(l.ERROR, { url: b })
            }
    ...
    function(f) {
        ...
        f.plugins.pluginloader = function(c,
            g) {
            function f() { q || (q = !0, r = d.loaderstatus.COMPLETE, u.sendEvent(l.COMPLETE)) }

            function a() {
                if (!w && ((!h || 0 === b.keys(h).length) && f(), !q)) {
                    var a = c.getPlugins();
                    m = b.after(p, f);
                    d.foreach(h, function(b) { b = d.getPluginName(b);
                        var c = a[b];
                        b = c.getJS();
                        var e = c.getTarget(),
                            c = c.getStatus();
                        c === d.loaderstatus.LOADING || c === d.loaderstatus.NEW || (b && !d.versionCheck(e) && u.sendEvent(l.ERROR, { message: "Incompatible player version" }), m()) }) } }
            ...
            this.load = function() {
                if (!(d.exists(g) && "object" !== d.typeOf(g))) { r = d.loaderstatus.LOADING;
                    j(g, function(b) { d.exists(b) && (b = c.addPlugin(b), b.addEventListener(l.COMPLETE, a), b.addEventListener(l.ERROR, e)) });
                    var b = c.getPlugins();
                    j(b, function(a, b) { b.load() }) }
                a() };
    ...
    function(f) { f.parsers = { localName: function(d) {
                return d ? d.localName ? d.localName : d.baseName ? d.baseName : "" : "" }, textContent: function(d) {
                return d ? d.textContent ? f.utils.trim(d.textContent) : d.text ? f.utils.trim(d.text) : "" : "" }, getChildNode: function(d, f) {
                return d.childNodes[f] }, numChildren: function(d) {
                return d.childNodes ? d.childNodes.length : 0 } } }(jwplayer),
    function(f) {
        var d = f.parsers;
        (d.jwparser = function() {}).parseEntry = function(l, b) {
            for (var j = [], c = [], g = f.utils.xmlAttribute, k = 0; k < l.childNodes.length; k++) {
                ...
                if ("jwplayer" === a.prefix) {
                    var e = d.localName(a); "source" === e ? (delete b.sources, j.push({ file: g(a, "file"), "default": g(a, "default"), label: g(a, "label"), type: g(a, "type") })) : "track" === e ? (delete b.tracks, c.push({ file: g(a, "file"), "default": g(a, "default"), kind: g(a, "kind"), label: g(a, "label") })) : (b[e] = f.utils.serialize(d.textContent(a)), "file" === e && b.sources && delete b.sources) }
            ...
            for (r = 0; r < c(f); r++)
                if (e = f.childNodes[r], "media" === e.prefix && b(e)) switch (b(e).toLowerCase()) {
                    case "content":
                        ...
                        l(e, "url") && (a.sources || (a.sources = []), a.sources.push({ file: l(e, "url"), type: l(e, "type"), width: l(e, "width"), label: l(e, "label") }));
                        break;
                    case "title":
                        a.title = j(e);
                        break;
                    ...
                    case "subtitle":
                        ...
                        if (0 < l(e, "lang").length) {
                            var p = h;
                            e = l(e, "lang");
                            var m = { zh: "Chinese", nl: "Dutch", en: "English", fr: "French", de: "German", it: "Italian", ja: "Japanese", pt: "Portuguese", ru: "Russian", es: "Spanish" };
                            e = m[e] ? m[e] : e;
                            p.label = e }
                        q.push(h)
                }
        ...
        f.rssparser.parse = function(b) {
            for (var a = [], e = 0; e < c(b); e++) {
                ...
                if ("channel" === g(f).toLowerCase())
                    for (var l = 0; l < c(f); l++) {
                        var h = j(f, l); "item" === g(h).toLowerCase() && a.push(d(h)) } }
            return a }
    }(jwplayer.parsers),
    function(f) {
        var d = f.utils,
        ...
        f.playlist = function(b) {
            var c = [];
            b = l.isArray(b) ? b : [b];
            l.each(b, function(b) { c.push(new f.playlist.item(b)) });
            return c };
        ...
        var b = f.playlist.filterSources = function(b, c, g) {
            ...
            if (b) return l.each(b, function(b) {
                if (!b || !b.file) b = void 0;
                    ...
                    b = d.extend({}, b, { file: c, type: f }) }
                b && e(b.file, b.type, g) && (k = k || b.type, b.type === k && a.push(b)) }), a }
    }(jwplayer),
    function(f) {
        ...
        f.playlist.loader = function() {
            function j(a) {
                try {
                    ...
                    a = "";
                    for (var d = 0; d < c.length && !(a = c[d], 8 !== a.nodeType); d++); "xml" === b.localName(a) && (a = a.nextSibling);
                    if ("rss" !== b.localName(a)) g("Not a valid RSS feed");
                    else {
                        var j = new f.playlist(b.rssparser.parse(a));
                        k.sendEvent(l.JWPLAYER_PLAYLIST_LOADED, { playlist: j }) } } catch (h) { g() } }

            function c(a) { g(a.match(/invalid/i) ? "Not a valid RSS feed" : "") }

            function g(a) { k.sendEvent(l.JWPLAYER_ERROR, { message: a ? a : "Error loading file" }) }
            var k = new l.eventdispatcher;
            d.extend(this, k);
            this.load = function(a) { d.ajax(a, j, c) }
        }
    }(jwplayer),
    function(f) {
        var d = jwplayer.utils,
        ...
        f.source = function(b) {
            var f = d.extend({}, l);
            d.foreach(l, function(c) { d.exists(b[c]) && (f[c] = b[c], delete b[c]) });
    ...
    function(f) {
        ...
        var l = f.utils,
            ...
            c = f.embed = function(g) {
                function k() {
                    if (!z) {
                        ...
                        if (j.isArray(e)) {
                            if (0 === e.length) { r();
                                return }
                            if (1 === e.length && (!e[0].sources || 0 === e[0].sources.length || !e[0].sources[0].file)) { r();
                                return } }
                        if (!x)
                            if (j.isString(e)) v = new f.playlist.loader,
                                v.addEventListener(b.JWPLAYER_PLAYLIST_LOADED, function(a) { p.playlist = a.playlist;
                                    x = !1;
                                    k() }), v.addEventListener(b.JWPLAYER_ERROR, function(a) { x = !1;
                                    r(a) }), x = !0, v.load(p.playlist);
                            ...
                            for (e = 0; e < p.modes.length; e++) {
                                ...
                                if (h && c[h]) {
                                    var m = l.extend({}, p);
                                    B = new c[h](F, d, m, n, g);
                                    if (B.supportsConfig()) return B.addEventListener(b.ERROR, a), B.embed(), l.css("object.jwswf, .jwplayer:focus", { outline: "none" }), l.css(".jw-tab-focus:focus", { outline: "solid 2px #0B7EF4" }),
                                        g
                                }
                            }
                ...
                function a(a) { h(u + a.message) }

                function e(a) { g.dispatchEvent(b.JWPLAYER_ERROR, { message: "Could not load plugin: " + a.message }) }

                function r(a) { a && a.message ? h("Error loading playlist: " + a.message) : h(u + "No playable sources found") }
                ...
                function h(a) { z || (t.parentNode.replaceChild(F, t), p.fallback ? (z = !0, d(F, a, p), q(a, !0)) : q(a, !1)) }
                ...
                l.foreach(p.events, function(a, b) {
                    var c = E[a]; "function" === typeof c && c.call(E, b) });
                var F = document.createElement("div");
                F.id = t.id;
                F.style.width = 0 < m.toString().indexOf("%") ? m : m + "px";
                F.style.height = 0 < w.toString().indexOf("%") ? w : w + "px";
                this.embed = function() { z || (n.addEventListener(b.COMPLETE, k), n.addEventListener(b.ERROR, e), n.load()) };
                this.destroy = function() { B && (B.destroy(), B = null);
                    n && (n.destroy(), n = null);
    ...
    function(f) {
        function d(c) {
            if (c.playlist)
                ...
                var f = {};
                b.foreach(j.defaults, function(a) { l(c, f, a) });
                f.sources || (c.levels ? (f.sources = c.levels, delete c.levels) : (d = {}, l(c, d, "file"), l(c, d, "type"), f.sources = d.file ? [d] : []));
                c.playlist = [new j(f)]
            }
        }

        function l(c, d, f) { b.exists(c[f]) && (d[f] = c[f], delete c[f]) }
        var b = f.utils,
            j = f.playlist.item;
        (f.embed.config = function(c) {
            var g = { fallback: !0, height: 270, primary: "html5", width: 480, base: c.base ? c.base : b.getScriptPath("jwplayer.js"), aspectratio: "" };
            c = b.extend({}, g, f.defaults, c);
            var g = { type: "html5", src: c.base + "jwplayer.html5.js" },
                k = { type: "flash", src: c.base + "jwplayer.flash.swf" };
            ...
            if ("string" !== typeof k || !b.exists(k)) g = 0;
                ...
                var a = k.indexOf(":"); - 1 === a ? g = 0 : (g = parseFloat(k.substr(0, a)), k = parseFloat(k.substr(a + 1)), g = 0 >= g || 0 >= k ? 0 : 100 * (k / g) + "%") } - 1 === c.width.toString().indexOf("%") ?
                delete c.aspectratio : g ? c.aspectratio = g : delete c.aspectratio;
            return c
        }).addConfig = function(c, f) { d(f);
            return b.extend(c, f) }
    }(jwplayer),
    function(f) {
        function d(b, d) {
            function c(a, b) { f[k].style[a] = b }
            for (var f = document.querySelectorAll(b), k = 0; k < f.length; k++) l.foreach(d, c) }
        var l = f.utils;
        f.embed.download = function(b, f, c) {
            function g(a, b, c) { a = document.createElement(a);
            ...
            var k = l.extend({}, f),
                ...
                q;
            f = f.logo ? f.logo : { prefix: l.repo(), file: "logo.png", margin: 10 };
            var h, p, m, w, u, t;
            p = k.playlist;
            k = ["mp4", "aac", "mp3"];
            if (p && p.length) {
        ...
        (f.embed.flash = function(c, g, k, a, e) {
            ...
            function h(a) {
                ...
                d.foreach(a, function(a, e) {
                    ...
                    c.push(a);
                    d.foreach(e, function(a, c) { b[f + "." + a] = c }) });
                b.plugins = c.join(",");
                return b }
            ...
            this.embed = function() {
                k.id = e.id;
                if (10 > m) return p.sendEvent(l.ERROR, { message: "Flash version must be 10.0 or greater" }), !1;
                var f, j, t = c.id,
                    n = e.config.listbar,
                    v = d.extend({}, k);
                ...
                j = d.getCookies();
                d.foreach(j, function(a, b) { "undefined" === typeof v[a] && (v[a] = b) });
    ...
    function(f) {
            ...
            function l(a, b, e) {
                return function() {
                    try {
                        ...
                        e && d.appendChild(b);
                        "function" === typeof a.resize && (a.resize(d.clientWidth, d.clientHeight), setTimeout(function() { a.resize(d.clientWidth, d.clientHeight) }, 400));
                        b.left = d.style.left;
                        b.top = d.style.top
                    } catch (f) {}
                }
        ...
        f.embed.html5CanPlay = function(b, g, k) {
            ...
            g = g || l.extType(a);
            if ("hls" === g)
                if (k) { k = d.isAndroidNative;
                    if (k(2) || k(3) || k("4.0")) return !1;
                    if (d.isAndroid()) return !0 } else if (d.isAndroid()) return !1;
            if (d.isRtmp(b, g)) return !1;
            b = l[g] || l[a];
            if (!b || b.flash && !b.html5) return !1;
            var e;
            a: if (b = b.html5) {
                try { e = !!f.vid.canPlayType(b);
                    break a } catch (j) {}
                e = !1 } else e = !0;
            return e }
    }(jwplayer),
    function(f) {
        ...
        f.embed = b.extend(function(g) {
            function k() { v = "Adobe SiteCatalyst Error: Could not find Media Module" }
            var a = b.repo(),
            ...
            switch (n) {
                case "ads":
                case "enterprise":
                    if (l.sitecatalyst) try { window.s && window.s.hasOwnProperty("Media") ? new f.embed.sitecatalyst(g) : k() } catch (x) { k() }
                case "premium":
    ...
    function(f) {
        ...
        f.sitecatalyst = function(f) {
            function b(b) { a.debug && d.log(b) }

            function j(a) { a = a.split("/");
                a = a[a.length - 1];
                a = a.split("?");
                return a[0] }
            ...
            function g() { m || (c(), m = !0, b("close: " + r), s.Media.close(r), w = !0, h = 0) }
            var k = f,
                ...
                e = {
                    ...
                    //         r = c;
                    //         q = a.playerName ? a.playerName : k.id } catch (f) { d.log(f) } },
                    onTime: function() {
                        if (w) {
                            var a = k.getDuration();
                            if (-1 == a) return;
                ...
                m = !0,
                w;
            d.foreach(e, function(a) { k[a](e[a]) })
        }
    }(jwplayer.embed),
    function(f) {
        function d(b, d) { b[d] && (b[d] = l.getAbsolutePath(b[d])) }
        var l = f.utils,
            b = f._,
            j = window.location.href;
        f.cast.setupCastConfig = function(b, g) {
            var k = l.extend({}, b.config);
            k.cast = l.extend({ pageUrl: j }, g);
            ...
            for (var r in a)
                if (a.hasOwnProperty(r)) {
                    var q = a[r];
                    if (q.client && (/[\.\/]/.test(q.client) && d(q, "client"), -1 < q.client.indexOf("vast"))) { e = k;
                        q = l.extend({}, q);
                        q.client = "vast";
        ...
        f.cast.setupFlashCastConfig = function(c) {
            ...
            (j = b.find(d.plugins, function(a, b) {
                return 0 < b.indexOf("vast.js") })) ? (j.client = "vast", j = { advertising: j }) : j = {};
            d = b.pick(d, "id captionLabel cast key playlist repeat".split(" "));
            d.cast.pageUrl = window.location.href;
            l.extend(d, { playerVersion: f.version, captionLabel: l.getCookies().captionLabel, volume: c.getVolume(), mute: c.getMute(), id: c.id, position: c.getPosition(), item: c.getPlaylistIndex() },
                j);
            return d
        }
    }(window.jwplayer),
    function(f, d) {
        function l(a, b) { a[b] && (a[b] = j.getAbsolutePath(a[b])) }
        var b = d.cast,
            j = d.utils,
            c = d.events,
            g = c.state,
        ...
        b.debug = !1;
        b.availability = null;
        b.available = function(a) { a = a || b.availability;
            var c = f.chrome,
                d = "available";
        ...
        b.controller = function(a, e) {
            ...
            function h(a, c) {
                ...
                void 0 !== c && (d.args =
                    c);
                A.sendMessage(b.NS, d, N, function(a) { b.log("error message", a); "Invalid namespace" === a.description && x() })
            }

            function p(a) { a = !!b.available(a.availability);
                M.available !== a && (M.available = a, t(c.JWPLAYER_CAST_AVAILABLE)) }

            function m(a) { b.log("existing session", a);!A && !H && (H = a.session, H.addMessageListener(b.NS, w)) }
            ...
            function w(f, g) {
                ...
                if (h.reconcile) {
                    ...
                    j.id === a.id && (h.appid === G.appid && h.pageUrl === T) && (A || (a.jwInstreamState() && a.jwInstreamDestroy(!0), B(k), e.sendEvent(c.JWPLAYER_PLAYER_STATE, { oldstate: j.oldstate, newstate: j.newstate })), P(h));
                    H = null
                }
            }

            function u(a) { M.active = !!a;
                a = M;
                var b;
            ...
            function x() { A ? (F(), A.stop(E, z), Q({ item: 0 }), P({ type: "state", diff: { buffer: 0, position: 0, duration: 0 } })) : E() }

            function z(a) { b.error("Cast Session Stop error:", a, A);
                E() }
            ...
            function B(k) {
                ...
                if (A) x(), O = k;
                    ...
                    a.jwPlay = function(a) {!1 === a ? D.pause() : D.play() };
                    a.jwPause = function(b) { a.jwPlay(!!b) };
                    a.jwLoad = function(a) { "number" === j.typeOf(a) && e.setItem(a);
                        D.load(a) };
                    a.jwPlaylistItem = function(a) { "number" === j.typeOf(a) && e.setItem(a);
                        D.playlistItem(a) };
                    a.jwPlaylistNext = function() { a.jwPlaylistItem(e.item + 1) };
                    a.jwPlaylistPrev = function() { a.jwPlaylistItem(e.item - 1) };
                    a.jwSetVolume = function(a) {
                        j.exists(a) && (a = Math.min(Math.max(0, a), 100) | 0, R(a) && (a =
                            Math.max(0, Math.min(a / 100, 1)), A.setReceiverVolumeLevel(a, K, function(a) { b.error("set volume error", a);
                                K() })))
                    };
                    a.jwSetMute = function(a) { j.exists(a) || (a = !I.mute);
                        S(a) && A.setReceiverMuted(!!a, K, function(a) { b.error("set muted error", a);
                            K() }) };
                    ...
                    a.jwSetCurrentCaptions = function(a) { p(a);
            ...
            function y(a) { b.log("Cast Session status", a);
                a ? K() : (D.sendEvent(c.JWPLAYER_PLAYER_STATE, { oldstate: e.state, newstate: g.BUFFERING }), E()) }
            ...
            function E() {
                ...
                if (L) {
                    ...
                    D && (D.destroy(), D = null);
                    C && (C.destroy(), C = null);
                    e.state !== g.IDLE ? j.isIPad() || j.isIPod() ? (a.jwStop(!0), L.sendEvent(c.JWPLAYER_PLAYER_STATE, { oldstate: g.BUFFERING, newstate: g.IDLE })) : (e.state = g.IDLE, a.jwPlay(!0), a.jwSeek(e.position)) : L.sendEvent(c.JWPLAYER_PLAYER_STATE, { oldstate: g.BUFFERING, newstate: g.IDLE });
                    L = null
                }
                u(!1);
                null !== O && (B(O), O = null)
            ...
            function F() { A.removeUpdateListener(y);
            ...
            function P(d) {
                if ("state" ===
                    d.type) {
                    if (C && (d.diff.newstate || d.diff.position)) C.destroy(), C = null, e.setVideoProvider(D), e.sendEvent(c.JWPLAYER_CAST_AD_CHANGED, { done: !0 });
                    D.updateModel(d.diff, d.type);
                    Q(d.diff) } else if ("ad" === d.type) { null === C && (C = new b.adprovider(b.NS, A), C.init(), e.setVideoProvider(C));
                    ...
                    d.diff.complete && C.resetAdModel() } else "connection" ===
                    d.type ? !0 === d.closed && x() : b.error("received unhandled message", d.type, d)
            }

            function Q(a) { void 0 !== a.item && e.item !== a.item && (e.item = a.item, e.sendEvent(c.JWPLAYER_PLAYLIST_ITEM, { index: e.item })) }
            ...
            function R(a) {
                var b = I.volume !== a;
                b && (I.volume = a, D.sendEvent(c.JWPLAYER_MEDIA_VOLUME, { volume: a }));
                return b }

            function S(a) {
                var b = I.mute !== a;
                b && (I.mute = a, D.sendEvent(c.JWPLAYER_MEDIA_MUTE, { mute: a }));
                return b }

            function N() {}
            var A = null,
                M = { available: !1, active: !1, deviceName: "" },
            ...
            this.startCasting = function() { A || a.jwInstreamState() || f.chrome.cast.requestSession(B, n) };
            this.stopCasting =
                x;
            this.openExtension = function() { a.jwInstreamState() || f.chrome.cast.requestSession(B, v) }
        };
        b.log = function() {
            if (b.debug) {
                var a = Array.prototype.slice.call(arguments, 0);
    ...
    function(f) {
        function d(a) { h.log("existing session", a);!y && !x && (x = a.session, x.addMessageListener(h.NS, l)) }
        ...
        function b() { y && (y.removeUpdateListener(e), y.removeMessageListener(h.NS, k), y.stop(j.bind(this), a.bind(this)), y = null);
            r(u, n.cleanup) }

        function j() { "undefined" !== typeof z && null !== z && (g(z), z = null) }

        function c(a, b) {
            y.sendMessage(h.NS, { command: a, args: b },
                p.noop,
                function(a) { h.error("message send error", a) })
        }

        function g(a) {
            var d = f(u);
            y ? (b(), z = a) : (y = a, y.addMessageListener(h.NS, k), y.addUpdateListener(e), d = f.cast.setupFlashCastConfig(d), x !== y && (c("setup", d), f.cast.loader.sendDummyMedia(y)), r(u, n.connected, { receiverFriendlyName: a.receiver.friendlyName })) }
        ...
        function a(a) { r(u, n.error, a || {}) }

        function e(a) { a ? q() : b() }

        function r(a, b, c) { c ? f(a).callInternal(b, c) : f(a).callInternal(b) }
        ...
        h.flash = {
            checkAvailability: function(a, b, c) { n = c;
                v = b;
                t[a] = !0;
                h.loader.addEventListener("availability", function(b) { "available" === b.availability && r(a, n.available, b) });
                h.loader.addEventListener("session", d);
                h.loader.initialize(b) },
            startCasting: function(b) { u = b;
                w.cast.requestSession(g.bind(this), a.bind(this)) },
            stopCasting: b,
            openExtension: function(b) { u = b;
                w.cast.requestSession(g.bind(this), a.bind(this)) },
            mute: function(a) { y.setReceiverMuted(a, q, function(a) { h.error("set muted error", a) }) },
            volume: function(a) { a = Math.max(0, Math.min(a / 100, 1));
                y.setReceiverVolumeLevel(a, q, function(a) { h.error("set volume error", a) }) },
            messageReceiver: c,
    ...
    function(f, d) {
        ...
        function b() { d && d.cast && d.cast.isAvailable && !e.apiConfig ? (e.apiConfig = new d.cast.ApiConfig(new d.cast.SessionRequest(m), k, a, d.cast.AutoJoinPolicy.ORIGIN_SCOPED), d.cast.initialize(e.apiConfig, g, c)) : 15 > p++ && setTimeout(b, 1E3) }

        function j() { h && (h.resetEventListeners(), h = null) }

        function c() { e.apiConfig = null }

        function g() {}

        function k(a) { w.sendEvent("session", { session: a });
            a.sendMessage(e.NS, { whoami: 1 });
            0 === a.media.length && l(a) }

        function a(a) { e.availability = a;
            w.sendEvent("availability", { availability: a }) }
        window.chrome = d;
        var e = f.cast,
            r = f.utils,
            q = f.events,
            ...
            w = r.extend({
                initialize: function(a) {
                    m = a;
                    null !== e.availability ? w.sendEvent("availability", { availability: e.availability }) : d && d.cast ? b() : h || (h = new r.scriptloader("https://www.gstatic.com/cv/js/sender/v1/cast_sender.js"), h.addEventListener(q.ERROR, j), h.addEventListener(q.COMPLETE,
                        b), h.load())
                }
    ...
    function(f, d) {
        ...
        f.api = function(h) {
            function g(a, c) { b.foreach(a, function(a, b) { n[a] = function(a) {
                        return c(b, a) } }) }
            ...
            function u(a, b) { v[a] || (v[a] = [], z && B && w(z, a));
                v[a].push(b);
                return n }
            ...
            n.id = h.id;
            n.setup = function(a) {
                if (f.embed) { f.api.destroyPlayer(n.id);
            ...
            n.removeButton = function(a) { t("jwDockRemoveButton", a) };
            n.callback = function(a) {
                if (J[a]) J[a]() };
            n.getMeta = function() {
                return n.getItemMeta() };
            n.getPlaylist = function() {
                var a = t("jwGetPlaylist"); "flash" === n.renderingMode && b.deepReplaceKeyName(a, ["__dot__", "__spc__", "__dsh__", "__default__"], [".", " ", "-", "default"]);
                return a };
            n.getPlaylistItem = function(a) { b.exists(a) || (a = n.getPlaylistIndex());
                return n.getPlaylist()[a] };
            n.getRenderingMode = function() {
                return n.renderingMode };
            // n.setFullscreen = function(a) { b.exists(a) ? t("jwSetFullscreen", a) : t("jwSetFullscreen", !t("jwGetFullscreen"));
            //     return n };
            n.setMute = function(a) { b.exists(a) ? t("jwSetMute", a) : t("jwSetMute", !t("jwGetMute"));
                return n };
            n.lock = function() {
                return n };
            n.unlock = function() {
                return n };
            n.load = function(a) { t("jwInstreamDestroy");
                f(n.id).plugins.googima && t("jwDestroyGoogima");
                t("jwLoad", a);
                return n };
            n.playlistItem = function(a) { t("jwPlaylistItem", parseInt(a, 10));
                return n };
            ...
            n.setInstream = function(a) {
                return E = a };
            n.loadInstream = function(a, b) { E = n.setInstream(n.createInstream()).init(b);
                E.loadItem(a);
                return E };
            n.destroyPlayer = function() { B = !0;
                t("jwPlayerDestroy") };
            // n.playAd = function(a) {
            ...
            //         t("jwPauseAd")
            // };
            g(q, function(a, b) { x[a] || (x[a] = [], u(j.JWPLAYER_PLAYER_STATE, function(b) {
                    var c = b.newstate;
                    b = b.oldstate;
                    if (c === a) {
                        var d = x[c];
                        if (d)
                            for (var e = 0; e < d.length; e++) {
                                var f = d[e]; "function" === typeof f && f.call(this, { oldstate: b, newstate: c }) } } }));
                x[a].push(b);
                return n });
            g(r, u);
            b.foreach(a, function(a, b) { m(!1, b) });
            b.foreach(e, function(a, b) { m(!0, b) });
            n.remove = function() {
                this._embedder && this._embedder.destroy && this._embedder.destroy();
                y = [];
                var a = 1 < c.size(c.where(l, { id: n.id }));
                a || b.clearCss("#" + n.id);
            ...
            n.dispatchEvent = function(a, c) {
                ...
                if (d)
                    for (var d = d.slice(0), e = b.translateEventResponse(a, c), f = 0; f < d.length; f++) {
                        var h =
                            d[f];
                        if ("function" === typeof h) try { a === j.JWPLAYER_PLAYLIST_LOADED && b.deepReplaceKeyName(e.playlist, ["__dot__", "__spc__", "__dsh__", "__default__"], [".", " ", "-", "default"]), h.call(this, e) } catch (g) { b.log("There was an error calling back an event handler", g) }
                    }
            };
            n.dispatchInstreamEvent = function(a) { E && E.dispatchEvent(a, arguments) };
            n.callInternal = t;
            n.playerReady = function(a) {
                B = !0;
                z || n.setPlayer(document.getElementById(a.id));
                n.container = document.getElementById(n.id);
                b.foreach(v, function(a) { w(z, a) });
                u(j.JWPLAYER_PLAYLIST_ITEM,
                    function() { F = {} });
                u(j.JWPLAYER_MEDIA_META, function(a) { b.extend(F, a.metadata) });
                u(j.JWPLAYER_VIEW_TAB_FOCUS, function(a) {
                    var c = n.getContainer();!0 === a.hasFocus ? b.addClass(c, "jw-tab-focus") : b.removeClass(c, "jw-tab-focus") });
        ...
        f.api.addPlayer = function(a) {
            ...
            l.push(a);
            return a };
        f.api.destroyPlayer = function(a) { a = c.where(l, { id: a });
    ...
    function(f) {
        ...
        f.api.instream = function(f, c) {
            ...
            function k(a, b) { q[a] || (q[a] = [], g(d.JWPLAYER_PLAYER_STATE, function(b) {
                    var c = b.newstate,
                        d = b.oldstate;
                    if (c === a) {
                        var e = q[c];
                        if (e)
                            for (var f = 0; f < e.length; f++) {
                                var g = e[f]; "function" === typeof g && g.call(this, { oldstate: d, newstate: c, type: b.type }) } } }));
                q[a].push(b);
                return this }
            var a, e, r = {},
                q = {},
                h = this;
            h.type = "instream";
            h.init = function() { f.callInternal("jwInitInstream");
                return h };
            h.loadItem = function(b, c) { a = b;
                e = c || {}; "array" === l.typeOf(b) ? f.callInternal("jwLoadArrayInstream", a, e) : f.callInternal("jwLoadItemInstream", a, e) };
            h.removeEvents = function() { r = q = {} };
            ...
            h.play = function(a) { c.jwInstreamPlay(a) };
            h.pause = function(a) { c.jwInstreamPause(a) };
            h.hide = function() { f.callInternal("jwInstreamHide") };
            h.destroy = function() { h.removeEvents();
                f.callInternal("jwInstreamDestroy") };
            h.setText = function(a) { c.jwInstreamSetText(a ? a : "") };
            h.getState = function() {
                return c.jwInstreamState() };
            h.setClick = function(a) { c.jwInstreamClick && c.jwInstreamClick(a) }
        }
    }(jwplayer),
    function(f) {
        var d = f.api,
        ...
        d.selectPlayer = function(b) {
            ...
            return c ? c : { registerPlugin: function(b, c, a) { "jwpsrv" !== b && f.plugins.registerPlugin(b, c, a) } } };
